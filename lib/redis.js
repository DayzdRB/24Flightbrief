...
function assertConfigured() {
  if (!BASE || !TOKEN) {
    throw new Error(
      'Redis is not configured. Set UPSTASH_REDIS_REST_URL / UPSTASH_REDIS_REST_TOKEN (or KV_REST_API_URL / KV_REST_API_TOKEN) in your environment variables.'
    );
  }
}
...
module.exports = { redisGet, redisSet, redisSetNx, redisDel };
