...
function setShortCookie(res, name, value, maxAgeSeconds = 600) {
  res.setHeader('Set-Cookie', `${name}=${encodeURIComponent(value)}; Max-Age=${maxAgeSeconds}; Path=/; HttpOnly; Secure; SameSite=Lax`);
}

module.exports = { getSessionUser, setSessionCookie, clearSessionCookie, parseCookies, setShortCookie };
